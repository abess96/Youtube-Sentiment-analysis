...
def _import_deep_learning_models():
    ...
    try:
        from src.models.deep_learning.deep_learning_models import (
...
def _import_transformer_models():
    ...
    try:
        from src.models.transformers.transformer_models import (
...
def _import_ensemble_models():
    ...
    try:
        from src.models.ensemble.ensemble_models import (

...
from src.model.hyperparameter_optimizer import BayesianOptimizer, AutoTuner
from src.model.mlflow_integration import MLflowTracker, ModelTrainingLogger
from src.model.dvc_integration import DVCManager, ModelVersionManager
...
def main():
    ...
    mlflow_tracker = MLflowTracker(
        experiment_name=mlflow_params.get('experiment_name', 'sentiment_analysis')
